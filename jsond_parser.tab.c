...
/* Line 390 of yacc.c  */
#line 190 "jsond_parser.tab.c"
/* Unqualified %code blocks.  */
/* Line 391 of yacc.c  */
#line 55 "jsond_parser.y"
...
{
       0,     0,     3,     6,     9,    10,    15,    16,    18,    22,
      28,    31,    34,    35,    40,    41,    43,    45,    49,    52,
...
{
      19,     0,    -1,    29,    10,    -1,    29,    30,    -1,    -1,
      12,    21,    22,    13,    -1,    -1,    23,    -1,    28,    14,
      29,    -1,    23,    15,    28,    14,    29,    -1,    23,    30,
      -1,    28,    30,    -1,    -1,    16,    25,    26,    17,    -1,
      -1,    27,    -1,    29,    -1,    27,    15,    29,    -1,    27,
      30,    -1,     8,    -1,     9,    -1,    20,    -1,    24,    -1,
       8,    -1,     9,    -1,     6,    -1,     7,    -1,     3,    -1,
       4,    -1,     5,    -1,    30,    -1,    11,    -1
};
...
{
       0,    76,    76,    77,    81,    81,    85,    86,    90,    91,
      92,    93,    97,    97,   101,   102,   106,   107,   108,   112,
...
static const char *const yytname[] =
{
  ...
  "start", "object", "$@1", "members", "member", "array", "$@2",
  "elements", "element", "key", "value", "errlex", YY_NULL
};
#endif
...
{
       0,    27,    28,    29,    25,    26,    23,    24,    31,     4,
      12,     0,    21,    22,     0,    30,     6,    14,     1,     2,
       3,    19,    20,     0,     7,     0,     0,    15,    16,     5,
       0,    10,     0,    11,    13,     0,    18,     0,     8,    17,
       0,     9
};
...
static const yytype_int8 yypact[] =
{
     ...
     -18,     8,   -18,   -18,     9,   -18,    18,    -2,   -18,   -18,
     -18,   -18,   -18,    16,     1,    14,    13,     2,   -18,   -18,
      18,   -18,    -2,   -18,   -18,    -2,   -18,    17,   -18,   -18,
      -2,   -18
};
...
{
      28,     1,     2,     3,     4,     5,     6,     7,    18,     8,
       9,    20,     8,     8,    10,    38,    30,    35,    39,    19,
       8,    31,    33,    41,    36,     8,    21,    22,    32,    29,
      34,    40,     0,    37
};
...
{
      17,     3,     4,     5,     6,     7,     8,     9,     0,    11,
      12,    14,    11,    11,    16,    32,    15,    15,    35,    10,
      11,    24,    25,    40,    27,    11,     8,     9,    14,    13,
      17,    14,    -1,    30
};
...
static const yytype_uint8 yystos[] =
{
      ...
      16,    19,    20,    24,    29,    30,    21,    25,     0,    10,
      30,     8,     9,    22,    23,    28,    26,    27,    29,    13,
      15,    30,    14,    30,    17,    15,    30,    28,    29,    29,
      14,    29
};
...
/* Line 1398 of yacc.c  */
#line 53 "jsond_parser.y"
        { zval_dtor(&(*yyvaluep)); };
/* Line 1398 of yacc.c  */
#line 1156 "jsond_parser.tab.c"
        break;
...
#line 76 "jsond_parser.y"
  ...
  case 3:
/* Line 1807 of yacc.c  */
#line 77 "jsond_parser.y"
    { PHP_JSON_USE_2((yyval), (yyvsp[(1) - (2)]), (yyvsp[(2) - (2)])); }
    break;

  case 4:
/* Line 1807 of yacc.c  */
#line 81 "jsond_parser.y"
    { PHP_JSON_DEPTH_INC; }
    break;
...
/* Line 1807 of yacc.c  */
#line 81 "jsond_parser.y"
    { PHP_JSON_DEPTH_DEC; php_json_parser_object_to_zval(parser, &(yyval), &(yyvsp[(3) - (4)])); }
    break;

  case 6:
/* Line 1807 of yacc.c  */
#line 85 "jsond_parser.y"
    { php_json_parser_ht_init(&(yyval), 0); }
    break;

  case 8:
/* Line 1807 of yacc.c  */
#line 90 "jsond_parser.y"
    { php_json_parser_ht_init(&(yyval), 4); php_json_parser_ht_update(parser, &(yyval), &(yyvsp[(1) - (3)]), &(yyvsp[(3) - (3)])); }
    break;

  case 9:
/* Line 1807 of yacc.c  */
#line 91 "jsond_parser.y"
    { php_json_parser_ht_update(parser, &(yyvsp[(1) - (5)]), &(yyvsp[(3) - (5)]), &(yyvsp[(5) - (5)])); (yyval) = (yyvsp[(1) - (5)]); }
    break;

  case 10:
/* Line 1807 of yacc.c  */
#line 92 "jsond_parser.y"
    { PHP_JSON_USE_2((yyval), (yyvsp[(1) - (2)]), (yyvsp[(2) - (2)])); }
    break;

  case 11:
/* Line 1807 of yacc.c  */
#line 93 "jsond_parser.y"
    { PHP_JSON_USE_2((yyval), (yyvsp[(1) - (2)]), (yyvsp[(2) - (2)])); }
    break;

  case 12:
/* Line 1807 of yacc.c  */
#line 97 "jsond_parser.y"
    { PHP_JSON_DEPTH_INC; }
    break;
...
/* Line 1807 of yacc.c  */
#line 97 "jsond_parser.y"
    { PHP_JSON_DEPTH_DEC; php_json_parser_array_to_zval(&(yyval), &(yyvsp[(3) - (4)])); }
    break;

  case 14:
/* Line 1807 of yacc.c  */
#line 101 "jsond_parser.y"
    { php_json_parser_ht_init(&(yyval), 0); }
    break;
...
#line 106 "jsond_parser.y"
    { php_json_parser_ht_init(&(yyval), 4); php_json_parser_ht_append(&(yyval), &(yyvsp[(1) - (1)])); }
    break;

  case 17:
/* Line 1807 of yacc.c  */
#line 107 "jsond_parser.y"
    { php_json_parser_ht_append(&(yyvsp[(1) - (3)]), &(yyvsp[(3) - (3)])); (yyval) = (yyvsp[(1) - (3)]); }
    break;

  case 18:
/* Line 1807 of yacc.c  */
#line 108 "jsond_parser.y"
    { PHP_JSON_USE_2((yyval), (yyvsp[(1) - (2)]), (yyvsp[(2) - (2)])); }
    break;

  case 31:
/* Line 1807 of yacc.c  */
#line 130 "jsond_parser.y"
    { PHP_JSON_USE_1((yyval), (yyvsp[(1) - (1)])); YYERROR;}
    break;


/* Line 1807 of yacc.c  */
#line 1723 "jsond_parser.tab.c"
      default: break;
    }

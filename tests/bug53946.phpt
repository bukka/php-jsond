...
--FILE--
<?php
var_dump(jsond_encode("latin 1234 -/    russian мама мыла раму  specialchars \x02   \x08 \n   U+1D11E >𝄞<"));
var_dump(jsond_encode("latin 1234 -/    russian мама мыла раму  specialchars \x02   \x08 \n   U+1D11E >𝄞<", JSOND_UNESCAPED_UNICODE));
var_dump(jsond_encode("ab\xE0"));
var_dump(jsond_encode("ab\xE0", JSOND_UNESCAPED_UNICODE));
?>
--EXPECTF--

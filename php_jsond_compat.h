...
#define PHP_JSOND_HAS_APPLY_COUNT(_tht)  (ZEND_HASH_GET_APPLY_COUNT(_tht) > 0)
#define PHP_JSOND_GET_APPLY_COUNT        ZEND_HASH_GET_APPLY_COUNT
#define PHP_JSOND_INC_APPLY_COUNT        ZEND_HASH_INC_APPLY_COUNT
#define PHP_JSOND_DEC_APPLY_COUNT        ZEND_HASH_DEC_APPLY_COUNT
#define PHP_JSOND_APPLY_PROTECTION       ZEND_HASH_APPLY_PROTECTION
#else
#define PHP_JSOND_HAS_APPLY_COUNT        GC_IS_RECURSIVE
#define PHP_JSOND_GET_APPLY_COUNT        GC_IS_RECURSIVE
#define PHP_JSOND_INC_APPLY_COUNT        GC_PROTECT_RECURSION
#define PHP_JSOND_DEC_APPLY_COUNT        GC_UNPROTECT_RECURSION
#define PHP_JSOND_APPLY_PROTECTION(_tht) (!(GC_FLAGS(_tht) & GC_IMMUTABLE))
#endif
